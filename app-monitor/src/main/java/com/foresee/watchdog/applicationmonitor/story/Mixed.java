...
public class Mixed {
    ...
    public void postConstruct() {
        ...
        monitor.register("Hierarchy_Leaves", leavesTest::testLeavesConditionGroup_8207581);
        LeaderboardTest leaderboardTest = new LeaderboardTest();
        monitor.register("Leaderboard", () -> {
            try {
